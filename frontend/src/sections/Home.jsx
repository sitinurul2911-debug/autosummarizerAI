            ...
            <div className="container relative" ref={parallaxRef}>
                <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
                    <h1 className="h1 mb-6">
                        Transform Reviews Into Clear {''}
                        <span className="inline-block relative">
                            Insight <img src={curve} className="absolute top-full left-0 w-full xl:-mt-2" width={624} height={28} alt="" />
                        </span>
                    </h1>
                    <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">Our cutting-edge AI technology analyzes thousands of customer reviews in seconds, extracting key insights, sentiment patterns, and actionable recommendations.</p>
                    
                    {/* GANTI INI - Pakai onClick dengan navigate */}
                    <Button onClick={() => navigate("/summarizer")} white>
                        Get started
                    </Button>
                </div>
                ...
                <div className="hidden relative z-10 mt-20 lg:block">
                    <h5 className="tagline mb-6 text-center text-white/50">Helping people to get better insights of their reviews</h5>
                    <ul className="flex">
